...
mgene_data = load('processed_delRn_detection_data_std_022421.mat'); %rename me
...
X_Otsu = [0.5 0.5 1 2 3 3]; %change Otsu threshold at cycle i (counter bias from noisy drops, 0.5 at cycle 1)
...
P_delRn_C1 = 0.001; %fraction of positive drops at cycle 1 used for min thresholed (0.005)
