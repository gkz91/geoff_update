...
%% Inputs
dataname = 'detection_data_IAV_032421.mat'; %rename me
...
T_FAM = [1 1e4; 1 0.5e4; 1 0.375e4; 1 0.41e4; 1 0.28e4; 1 0.16e4]; %manual FAM threshold
...
P_TIME = 0.20; %+/- median range filter on TIME (0.2)
