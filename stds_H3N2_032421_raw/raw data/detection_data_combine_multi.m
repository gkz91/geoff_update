...
filename = 'detection_data_std_032421.mat'; %UPDATE

%% Load Data

A{1} = importdata('mgene_1_peaks_100kHz_8.txt');
A{2} = importdata('mgene_2_peaks_100kHz_7.txt');
A{3} = importdata('mgene_3_peaks_100kHz_6.txt');
A{4} = importdata('mgene_4_peaks_100kHz_5.txt');
A{5} = importdata('mgene_5_peaks_100kHz_4.txt');
A{6} = importdata('mgene_6_peaks_100kHz_3.txt');
A{7} = importdata('mgene_7_peaks_100kHz_2.txt');
A{8} = importdata('mgene_40_peaks_100kHz_1.txt');
