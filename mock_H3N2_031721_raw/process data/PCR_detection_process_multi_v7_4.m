...
%% Inputs
dataname = 'detection_data_mock_031721.mat'; %rename me
mgene_data = load('processed_delRn_detection_data_std_031721.mat'); %rename me
...
T_FAM = [1 1e4; 1 3e3; 1 0.5e4; 1 0.5e4; 1 0.5e4; 1 0.5e4]; %manual FAM threshold
