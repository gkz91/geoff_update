...
%% Inputs
dataname = 'detection_data_mock_021221.mat'; %rename me
...
T_time = [3 6; 3 6; 4 8; 5 10; 5 10; 5 10; 5 10; 5 10];
%T_time = [0 10; 0 10; 0 10; 0 10; 0 10; 0 10; 0 10; 0 10]; %no filter
edges_time = linspace(0,10,nbins);

%ROX thresholds
T_ROX = [0.35 0.7; 0.35 0.7; 0.4 0.7; 0.4 0.7; 0.4 0.7; 0.4 0.7; 0.4 0.7; 0.4 0.7];
