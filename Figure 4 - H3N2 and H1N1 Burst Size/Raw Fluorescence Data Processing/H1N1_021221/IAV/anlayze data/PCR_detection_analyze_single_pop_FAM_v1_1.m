...
cycle = 28; %cycle data to convert
nbins = 30;
split_ratio = 1/8; %split ratio of EVO chip

edges_lin = linspace(100,4000,nbins);
edges_log = linspace(1,4,nbins);
...
PCR_data = load('processed_delRn_detection_data_std_021221.mat');
