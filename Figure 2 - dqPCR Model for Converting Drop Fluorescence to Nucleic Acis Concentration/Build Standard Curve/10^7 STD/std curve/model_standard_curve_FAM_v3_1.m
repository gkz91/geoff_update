...
%filename = 'processed_delRn_avgROX_detection_data_std_041621_outlier.mat';
filename = 'processed_delRn_detection_data_std_041621_outlier.mat';
...
cycle_graph = 19; %single cycle for figure 3
split_ratio = 1; %split ratio of EVO chip


%efficiency fitting
F_0 = 1; %initial fluorescence at cycle 1 (arbitrary, can't be zero)
a_eff_range = [0.00 0.1]; %initial guess of min efficiency [0 0.1]
b_eff_range = [0.5 3]; %intitial guess of slope [0.5 3]
c_eff_range = [16 18]; %initial guess of C_0.5 range [16 18]
d_eff_range = [.9 1]; %initial guess of max efficiency [0.9 1]
