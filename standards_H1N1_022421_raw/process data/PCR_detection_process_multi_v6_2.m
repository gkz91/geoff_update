...
%% Inputs
dataname = 'detection_data_std_022421.mat'; %rename me
...
T_time = [4.75 6.25; 4.75 6.25; 4.75 6.25; 4.75 6.25; 4.75 6.25; 4.75 6.25; 4.75 6.25; 4.75 6.25];
%T_time = [0 10; 0 10; 0 10; 0 10; 0 10; 0 10; 0 10; 0 10]; %no filter
edges_time = linspace(0,10,nbins);

%ROX thresholds

T_ROX = [0.55 0.75; 0.55 0.75; 0.55 0.75; 0.55 0.75; 0.45 0.7; 0.55 0.75; 0.55 0.75; 0.5 0.65];
%T_ROX = [0 10; 0 10; 0 10; 0 10; 0 10; 0 10; 0 10; 0 10]; %no filter
edges_ROX = linspace(0,1,nbins);

%delRn (FAM) thresholds (final cleanup)
T_delRn_FAM = [-0.05 0.05; -0.05 0.05; 0.035 0.2; 0.035 0.6; 0.035 0.8; 0.035 1; 0.035 1; 0.035 1.5]; 
...
T_delRn_CY5 = [-0.1 0.15; -0.1 0.5; -0.1 0.8; 0 1; 0 1.5; 0 1.5; 0.2 1.5; 0.2 2]; 
%T_delRn = [-2 10; -2 10; -2 10; -2 10; -2 10; -2 10; -2 10; -2 10]; %no filter
edges_delRn_CY5 = linspace(-0.2,1,nbins);
