...
%1-22-21 v3.1_multi updated for CY5 channel + cleaned code
%Geoff Zath

%2-24-21
%delRn normalization (CY5)
...
filename = 'processed_delRn_detection_data_std_022421.mat';

N_cycles = 40; %total number of thermal cycles
N_span = 1000; %number of model curves (increases resolution of span Ct fit)
E_PCR = 0.951; %PCR efficiency fraction (8-5-20 correctee data)
conc_fit = 171; %100 cpd fit post split (171 cpd) [corrected for dilution error]
...
c_eff_range = [14 16]; %initial guess of C_0.5 range
...
D_avg_curve = PCR_curve.delRn_CY5_avg_FINAL;
D_std_curve = PCR_curve.delRn_CY5_std_FINAL;
...
%save data
stats_savename = ['eff_CY5_stdcurve' filename(10:end)];
