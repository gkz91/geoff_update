...
C40_mgene_avg = 0.7977; %from std curve
C40_mgene_std = 0.1268;
T_C40 = C40_mgene_avg - C40_mgene_std;

edges_CY5 = linspace(0.4,1.4,nbins);

%FAM thresholds by drop #
T_FAM = [1 0.5e4; 1 4e3; 1 1.15e4; 1 7.5e3; 1 7.5e3; 1 3.5e3];
...
T_delRn_FAM = [0.1 0.67; 0.1 0.67; 0.1 0.67; 0.1 0.67; 0.1 0.67; 0.1 0.8]; 
