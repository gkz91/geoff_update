...
cycle = 19; %cycle data to convert
nbins = 20;
split_ratio = 1/8; %split ratio of EVO chip

edges_lin = linspace(0,500,nbins);
...
curve_data = load('eff_CY5_stdcurve_delRn_detection_data_std_021221.mat');
PCR_data = load('processed_delRn_detection_data_IAV_021221.mat');
