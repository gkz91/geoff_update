...
%% Inputs
dataname = 'detection_data_IAV_021921.mat'; %rename me
...
C40_mgene_avg = 0.8822; %from std curve
C40_mgene_std = 0.107;
...
T_FAM = [1 0.8e4; 3.5e3 8e3; 1.5e3 1.5e4; 1.2e4 1.7e4; 1 1e4; 1 6.7e3];
edges_FAM = linspace(0,0.5,nbins);

%time inside thresholds
T_time = [5 6.5; 5 6.5; 5 6.5; 5 6.5; 5 6; 5 6.5];
%T_time = [0 10; 0 10; 0 10; 0 10; 0 10; 0 10; 0 10; 0 10]; %no filter
edges_time = linspace(0,10,nbins);

%ROX thresholds
T_ROX = [0.3 0.5; 0.3 0.5; 0.3 0.5; 0.3 0.5; 0.3 0.5; 0.3 0.5; 0.3 0.5; 0.3 0.5];
...
T_delRn_FAM = [0.2 0.775; 0.2 0.775; 0.2 0.775; 0.2 0.775; 0.2 0.775; 0.2 1.2]; 
...
%T_delRn = [-2 10; -2 10; -2 10; -2 10; -2 10; -2 10; -2 10; -2 10]; %no filter
edges_delRn_CY5 = linspace(-0.1,2,nbins);
