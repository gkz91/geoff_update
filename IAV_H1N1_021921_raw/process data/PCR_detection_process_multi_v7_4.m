...
mgene_data = load('processed_delRn_detection_data_std_021921.mat'); %rename me
...
X_Otsu = [0.5 1 1 3 3 1]; %change Otsu threshold at cycle i (counter bias from noisy drops, 0.5 at cycle 1)
...
edges_delRn_FAM = linspace(-0.05,1,nbins);
...
%T_delRn = [-2 10; -2 10; -2 10; -2 10; -2 10; -2 10; -2 10; -2 10]; %no filter
edges_delRn_CY5 = linspace(-0.05,1,nbins);
