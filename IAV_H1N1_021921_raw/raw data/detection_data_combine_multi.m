...
Cycles = [1 19 22 25 28 40]; %UPDATE

filename = 'detection_data_IAV_021921.mat'; %UPDATE

%% Load Data

A{1} = importdata('IAV_1_peaks_100kHz_13.txt');
A{2} = importdata('IAV_2_peaks_100kHz_12.txt');
A{3} = importdata('IAV_3_peaks_100kHz_11.txt');
A{4} = importdata('IAV_4_peaks_100kHz_10.txt');
A{5} = importdata('IAV_5_peaks_100kHz_9.txt');
A{6} = importdata('IAV_40_peaks_100kHz_8.txt');
