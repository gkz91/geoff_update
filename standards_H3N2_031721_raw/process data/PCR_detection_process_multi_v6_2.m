...
%% Inputs
dataname = 'detection_data_std_031721.mat'; %rename me
...
T_time = [4.5 6; 4.5 6; 5 6; 5 6; 5 6; 4 6; 4.5 6; 4.5 6];
%T_time = [0 10; 0 10; 0 10; 0 10; 0 10; 0 10; 0 10; 0 10]; %no filter
edges_time = linspace(0,10,nbins);

%ROX thresholds

T_ROX = [0.2 0.325; 0.2 0.325; 0.2 0.325; 0.2 0.325; 0.2 0.325; 0.2 0.325; 0.2 0.325; 0.2 0.325];
%T_ROX = [0 10; 0 10; 0 10; 0 10; 0 10; 0 10; 0 10; 0 10]; %no filter
edges_ROX = linspace(0,1,nbins);

%delRn (FAM) thresholds (final cleanup)
T_delRn_FAM = [-0.1 0.1; -0.1 0.2; -0.1 0.3; 0.15 0.6; 0.15 1.3; 0.15 2.3; 0.15 2.3; 0.15 3]; 
...
T_delRn_CY5 = [-0.2 0.2; -0.2 0.5; 0 0.8; 0.25 1; 0.5 1.5; 0.5 1.5; 0.5 1.5; 0.5 2]; 
%T_delRn = [-2 10; -2 10; -2 10; -2 10; -2 10; -2 10; -2 10; -2 10]; %no filter
