...
cycle = 31; %cycle data to convert
nbins = 20;
split_ratio = 1/8; %split ratio of EVO chip

edges_lin = linspace(0,10000,nbins);
...
curve_data = load('eff_CY5_stdcurve_delRn_detection_data_std_012121.mat');
PCR_data = load('processed_delRn_detection_data_IAV_012121.mat');
%PCR_data = load('processed_delRn_detection_data_std_121420.mat');


PCR_cycles = PCR_data.cycle;
PCR_cycle_data = PCR_data.delRn_CY5_FINAL;
