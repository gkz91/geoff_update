...
%% Inputs
dataname = 'detection_data_IAV_031721.mat'; %rename me
...
T_FAM = [1 1e4; 1 0.7e4; 1 0.575e4; 1 0.6e4; 0.22e4 1.55e4; 1 0.5e4]; %manual FAM threshold
...
P_TIME = 0.15; %+/- median range filter on TIME (0.2)
...
delRn_auto = 'N'; %auto filter = Y, manual filter = N
...
T_delRn_FAM = [0.2 T_C40; 0.2 T_C40; 0.2 T_C40; 0.2 T_C40; 0.2 T_C40; 0.2 T_C40]; %manual delRn threshold
