...
%% Inputs
dataname = 'detection_data_std_021921.mat'; %rename me
...
T_time = [3.5 5; 3.5 5; 4 5.5; 3.5 5; 3 5; 3.5 5.5; 4 6; 3.5 5];
%T_time = [0 10; 0 10; 0 10; 0 10; 0 10; 0 10; 0 10; 0 10]; %no filter
edges_time = linspace(0,10,nbins);

%ROX thresholds

T_ROX = [0.35 0.55; 0.35 0.55; 0.35 0.55; 0.35 0.55; 0.35 0.55; 0.35 0.55; 0.35 0.55; 0.35 0.55];
%T_ROX = [0 10; 0 10; 0 10; 0 10; 0 10; 0 10; 0 10; 0 10]; %no filter
edges_ROX = linspace(0,1,nbins);

%delRn (FAM) thresholds (final cleanup)
T_delRn_FAM = [-0.1 0.1; -0.1 0.2; 0 0.2; 0.1 0.6; 0.2 0.8; 0.2 1; 0.2 1; 0.2 1.5]; 
...
T_delRn_CY5 = [-0.15 0.15; -0.15 0.5; -0.15 0.8; 0.1 1; 0.2 1.5; 0.2 1.5; 0.2 1.5; 0.2 2]; 
%T_delRn = [-2 10; -2 10; -2 10; -2 10; -2 10; -2 10; -2 10; -2 10]; %no filter
edges_delRn_CY5 = linspace(-0.2,2,nbins);
