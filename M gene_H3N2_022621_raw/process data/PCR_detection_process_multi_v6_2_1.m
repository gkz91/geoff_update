...
%1-21-21 v6.2.1 normalize to ROX avg
%Geoff Zath
...
%% Inputs
dataname = 'detection_data_std_022621.mat'; %rename me
...
T_delRn_CY5 = [-0.1 0.15; -0.1 0.5; -0.1 0.8; 0 1; 0 1.5; 0 1.5; 0 1.5; 0 2]; 
%T_delRn = [-2 10; -2 10; -2 10; -2 10; -2 10; -2 10; -2 10; -2 10]; %no filter
edges_delRn_CY5 = linspace(-0.1,0.5,nbins);
...
%     Rn_FAM_std(i) = std(FAM_temp_5./ROX_temp_5);
    Rn_FAM{i} = FAM_temp_5/ROX_avg(i);
    Rn_FAM_avg(i) = mean(FAM_temp_5/ROX_avg(i));
    Rn_FAM_std(i) = std(FAM_temp_5/ROX_avg(i));
    ...
    delRn_FAM{i} = (FAM_temp_5/ROX_avg(i)) - Rn_FAM_avg(1);
    delRn_FAM_avg(i) = mean((FAM_temp_5/ROX_avg(i)) - Rn_FAM_avg(1));
    delRn_FAM_std(i) = std((FAM_temp_5/ROX_avg(i)) - Rn_FAM_avg(1));
